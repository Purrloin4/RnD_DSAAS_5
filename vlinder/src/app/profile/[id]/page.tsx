...
// export default function ProfilePage({ params }: { params: { id: string } }) {
//     const [profile, setProfile] = useState<UserProfile | null>(null);
//     const [friendshipStatus, setFriendshipStatus] = useState<'friends' | 'pending' | 'rejected' | 'none'>('none');
...
//         try {
//             // Fetch friendship request status between the current user and the viewed profile
//             const { data, error } = await supabase
//                 .from('friend_requests')
//                 .select('status')
//                 .or(`profile_1_id.eq.${supabase.auth.user()?.id},profile_2_id.eq.${params.id}`)
//                 .single();
...
//             // Call the function to send a friend request
...
//             // Set the friendship status to pending after sending request
...
//                 <Button color="primary" onPress={sendRequest}>Send Friendship Request</Button>
//             )}
//             {friendshipStatus === 'pending' && (
//                 <Button color="warning" disabled>Request Pending</Button>
//             )}
//             {friendshipStatus === 'rejected' && (
//                 <Button color="error" disabled>Request Rejected</Button>
//             )}
