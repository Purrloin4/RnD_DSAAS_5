...
export default function ProfileCard({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <Skeleton className="text-lg rounded-full w-3/4 font-semibold text-gray-800 mb-4">{"Unnamed User"}</Skeleton>
      <Skeleton className="justify-self-end w-full py-2 rounded-md">See Profile</Skeleton>
    </Card>
  );
}
